...
It's fitting if you have OPM V5 volumetric clouds, which can be found here: 
https://spacedock.info/mod/4060/OPM%20Volumetric%20V5%20configs

depedicies are as follows: 
- Blackrocks EVE volumetric V5
...
The following below are some descriptions attached with images to showcase my config:
